...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="content">   
        	<div id="search">
    			<input type="text" id="searchWord" value="" placeholder="可按各编号/停车场/街道/城区名进行搜索" size="18px">
...
<script type="text/javascript">  
	...
	function showForm(){
		...
		$.ajax({
   			type:'GET',
     		url:'http://localhost:8080/park/' + param + '/form',
     		async:true,
     		data:{
     		},
	...
	function showData(data) {
		...
		str = str + "</tbody>";
		if(user_id == "admin")
			document.getElementById("name").innerHTML = "所有停车场信息&nbsp&nbsp&nbsp<a href=\"javascript:void(0)\" onclick=\"addParking()\">添加</a>";
		else
