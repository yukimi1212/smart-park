...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="content">   
        	<div id="search">
    			<input type="text" id="searchWord" value=${searchWord } placeholder="指定停车场类型" size="18px">
    			<button class="button" type="submit" onclick="doSearch()">搜索</button>
  				<a href="javascript:void(0)" onclick="getArea()" class="viewbutton" style="float:right" id="areaStatic">停车记录统计</a>
...
<script type="text/javascript">  
	...
	window.onload = function(){
		...
		if (source == "parkingarea"){
			...
			var type = $("#areaStatic").html("停车场统计");
			$.ajax({
				type:'GET',
	...
	function getArea(){
		...
		var url;
		if (source == "parkingarea")
			url = "http://localhost:8080/user/" + param + "/chartArea";
		else
			url = "http://localhost:8080/user/" + param + "/area";
		window.location.href=url;
	}
