...
<script type="text/javascript">  
	...
	function showData() {
		...
		str = str + "<a href=\"javascript:void(0)\" onclick=\"addParking()\" class=\"viewbutton\" >添加</a></td></tr>";
		str = str + "</tbody>";
		document.getElementById("name").innerHTML = "添加停车场 &nbsp&nbsp&nbsp<a href=\"javascript:void(0)\" onclick=\"returnForm()\" class=\"viewbutton\">返回</a>";
